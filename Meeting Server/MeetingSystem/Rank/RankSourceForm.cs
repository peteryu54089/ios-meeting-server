    ...
    public partial class RankSourceForm : Form
    {
        ...
        private void addButton_Click(object sender, EventArgs e)
        {
            ...
            if (parm != null)
            {
                ...
                RankSettingDataItem item = new RankSettingDataItem(id++, rankSource, rankResult, webSourePath, "", score);
                item.RankWebIp = String.Format("http://{0}/Rank.html", MeetingServer.getInstance().IP);
                list.Add(item);
                rankSourceTextBox.Text = String.Empty;
                rankResultTextBox.Text = String.Empty;
                IsScoreCk.Checked = false;
            }
            else
